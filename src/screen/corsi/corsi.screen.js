      ...
      <CourseWrapper>
        <CourseInfo>
          ...
          <CourseDescription>
            ...
            svolti sotto forma di gioco così da far avvicinare ed appassionare i
            piccoli a questa disciplina. L’utilizzo degli oggetti sarà la base
            di partenza per il nostro percorso.
          </CourseDescription>
        </CourseInfo>
      ...
      <CourseWrapper isReverse>
        <CourseInfo isReverse>
          ...
          <CourseDescription>
            ...
            Leningrado dal 1921 al 1957), in vigore presso l’Accademia Nazionale
            di Danza di Roma, con riferimenti anche alle tre grandi scuole:
            italiana, francese e americana. I Corsi di Danza Classica si
            suddividono in: inferiori, medi e superiori. Il repertorio classico
            costituisce il bagaglio culturale che ogni buon danzatore deve
            possedere, anche perché esso risulta indispensabile per sostenere
      ...
      <CourseWrapper>
        <CourseInfo>
          ...
          <CourseDescription>
            ...
            studiare con maestri di fama internazionale e coreografi di rinomate
      ...
      <CourseWrapper isReverse>
        <CourseInfo isReverse>
          ...
          <CourseDescription>
            ...
            stili che nel corso del tempo vari coreografi hanno sperimentato. È
            proprio nella sperimentazione di nuove gestualità che il modern
            trova terreno fertile ed è proprio in questa continua ricerca che
            esso supera i confini della danza accademica. Con lo studio di varie
            tecniche, in primo luogo quella classica, la creazione di
            coreografie e la ricerca di continui spunti gestuali e non consueti
            rende il modern uno stile molto particolare e in continua
      ...
      <CourseWrapper>
        <CourseInfo>
          ...
          <CourseDescription>
            ...
            timidezza e a superare i propri limiti, migliora il senso del ritmo
            e dello spazio, la coordinazione, il tempo di reazione e la
            consapevolezza della propria corporeità. L’obiettivo del corso è
            quello di avvicinare gli allievi ad una vera e propria cultura che è
            quella dell’Hip-Hop, attraverso la danza , la musica e le nozioni
            storiche.
          </CourseDescription>
        </CourseInfo>
      ...
      <CourseWrapper isReverse>
        <CourseInfo isReverse>
          ...
          <CourseDescription>
            ...
            fondamentali dall’hip hop e dal jazz, sviluppando le sue coreografie
            principalmente su musica pop e commerciale. L’espressività è
            fondamentale, se pensiamo che questo genere nasce proprio con
            l’obiettivo di danza davanti ad una telecamera. Il nome stesso
            infatti, “Video-dance” lascia intuire il legame di questa disciplina
            con i video musicali.
          </CourseDescription>
        </CourseInfo>
