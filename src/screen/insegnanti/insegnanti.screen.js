    ...
    <PageWrapper>
      ...
      <TeacherWrapper>
        <TeacherInfo>
          ...
          <TeacherDescription>
            ...
            inoltre parte della Stabile Napoletana ricoprendo ruoli di Ballerina
            Solista esibendosi nei maggiori Teatri Italiani (T. Argentina e T.
            Brancaccio di Roma, T. Politeama di Napoli, T. Verdi di Salerno, ed
            ancora ad Avellino, Benevento, Minori, Amalfi, Pescara, Nuoro,
            Frosinone, Latina…..). Partecipa ad alcuni spettacoli per la RAI con
            Carla Fracci, Paolo Bortoluzzi, Alfredo Kolner. Si perfeziona con i
            migliori maestri sia in Italia che all’estero (in Russia, Parigi,
            Londra, Copenaghen, Cannes …) per arricchire sempre più la tecnica e
            perfezionarne lo stile. Come coreografa oltre alla fedele
            ricostruzione di pagine di repertorio, lavora alla creazione di
            balletti inediti anche per spettacoli e manifestazioni nell’ambito
            provinciale e regionale, nonché alla realizzazione di coreografie
      ...
      <TeacherWrapper isReverse>
        <TeacherInfo isReverse>
          ...
          <TeacherDescription>
            Si è diplomata nel 1988 ed ha perfezionato i suoi studi con maestri
            internazionali quali Margarita Trayanova, Anna Maria Prima, Sauche
            Prijkof, Kirk Offerle, Celia Southern, Salaorni, A. Borriello, M.
            Ermini. Ha frequentato il corso di tecnica di propedeutica alla
            danza tenuto dalla prof.ssa Laura Fanetti. Si è dedicata
            all’insegnamento della danza classica, dopo essersi arricchita
            professionalmente seguendo per numerosi anni i corsi di “Tecnica
            della Danza e di Repertorio del Balletto Classico” tenuti da
            Margarita Trayanova. Nel corso degli anni è divenuta assistente di
            maestri come: Mario Piazza, Alex Atzewi, Angela Abbigliati.
          </TeacherDescription>
        </TeacherInfo>
      ...
      <TeacherWrapper>
        <TeacherInfo>
          ...
          <TeacherDescription>
            ...
            Modern puro all’Hip-hop. Negli ultimi anni si é specializzata nella 
            Contact Improvvisation per ampliare e ricercare diverse possibilità
            espressive,  di comunicazione e di gestualità.
          </TeacherDescription>
        </TeacherInfo>
      ...
      <GuestsWrapper>
        ...
        <Guest>
          ...
          <GuestDescription>
            ...
            “Giovanni Talenti” di Luigi Ferrone presso il teatro Giuseppe Verdi,
            per due anni consecutivi. Lavora con diverse scuole in Campania come
            coreografo e ballerino ospite.
          </GuestDescription>
        </Guest>
        <Guest>
        ...
        <Guest>
          ...
          <GuestDescription>
            Laureato all’accademia Nazionale di Danza, si è perfezionato con G.
            Cohen, V, N. Viroubuva, K. Damianov; primo ballerino della compagnia
            “Città di Ravenna”, ha approfondito lo stile bournonvilliano con i
            fratelli Flindt e quello americano con David Howard.
          </GuestDescription>
        </Guest>
        <Guest>
          ...
          <GuestDescription>
            ...
            della danza classica attraverso la sua lunga esperienza di ballerina
            e maestra di ballo delle compagnie tra le più importanti.
          </GuestDescription>
        </Guest>
        <Guest>
          ...
          <GuestDescription>
            Si perfeziona con maestri di fama internazionale per quanto riguarda
            il classico contemporaneo e moderno. Partecipa alla realizzazione
            del film “Balla che ti passa” e alla realizzazione di una puntata
            della fiction “Don Matteo 5”, e all’opera lirica “La Traviata”
            presso il teatro “Giuseppe Verdi” di Salerno. Collabora con scuole e
            compagnie della campania come insegnante, artista ospite e
            coreografo.
          </GuestDescription>
        </Guest>
      </GuestsWrapper>
